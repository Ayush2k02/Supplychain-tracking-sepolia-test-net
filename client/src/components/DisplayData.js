...
const DisplayData = () => {
  ...
  const ContractAddress = "0x57A638c2aCc3023b369c5b77167Ef99f0ba70643"; //"0xFa56954976bA7d616945c09A7e360499e7038d98";
              ...
              {data.map((row, iterator) => (
                ...
                >
                  ...
                  <StyledTableCell align="left">
                    {parseInt(row.temp._hex)}°C
                  </StyledTableCell>
                  <StyledTableCell align="left">
                    {parseInt(row.humidity._hex)}%
                  </StyledTableCell>
                  <StyledTableCell align="right">
                    {parseInt(row.hindex._hex)}°C
                  </StyledTableCell>
                </StyledTableRow>
              ))}
            </TableBody>
